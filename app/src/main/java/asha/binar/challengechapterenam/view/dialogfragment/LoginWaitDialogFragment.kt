...
import asha.binar.challengechapterenam.databinding.FragmentLoginWaitDialogBinding
...
class LoginWaitDialogFragment : DialogFragment() {
    ...
    private val viewModel: UserApiViewModel by hiltNavGraphViewModels(R.id.nav_mian)
